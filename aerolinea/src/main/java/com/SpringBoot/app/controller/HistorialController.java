...
public class HistorialController {
	...
	@PostMapping
	public ResponseEntity<?> guardar(@RequestBody Historial historial) {
		return ResponseEntity.status(HttpStatus.CREATED).body(historialService.guardarHistorial(historial));
	}
}
